...
public class _126_WordLadder_ii {
    public static void main(String[] args) {
        new _126_WordLadder_ii().findLadders("hit", "cog", Arrays.asList("hot", "dot", "dog", "lot", "log", "cog"));
    }
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        backTracing(beginWord, endWord, successors, path, res);
        return res;
    }
    ...
    private void backTracing(String beginWord, String endWord, Map<String, Set<String>> successors, Deque<String> path, List<List<String>> res) {
        ...
        for (String nextWord : successorWords) {
            ...
            backTracing(nextWord, endWord, successors, path, res);
            path.removeLast();
        }
    }
}
